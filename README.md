...
### 💧 Water Infrastructure & Public Safety Dashboard
End-to-end Power BI analytics solution using Star Schema modeling, ETL with Power Query, and interactive dashboards to support infrastructure planning.

### 🔍 Forensic Data Audit (SQL + Python)
Investigated data integrity issues, identified inconsistencies, and validated large datasets through automated checks and statistical analysis.

### ⚙️ Data Engineering Workflows
Built repeatable pipelines for cleaning, transforming, and preparing 25,000+ records for analysis and reporting.
